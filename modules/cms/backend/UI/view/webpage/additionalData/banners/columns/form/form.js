Ext.define('App.modules.cms.backend.UI.view.webpage.additionalData.banners.columns.form.form', {
    extend: 'Ext.form.Panel',
    
    alias: 'widget.cms_webpage_additionaldata_banners_columns_form_form',
            ...
            [    
                {
                    ...
                    labelAlign: 'right',
                    width: 200,
                    value: me.getPropertyValue('width', "100%")
                },   
                {
                    xtype: 'textfield',
                    name: 'height',
                ...
                {
                    xtype: 'label',
                    itemId: 'cms_webpage_additionaldata_banners_columns_form_form_images_msg_no_available_lang',
                ...
                },                     
                {
                    xtype: 'tabpanel',     
                    margin: '10 0 0 0',
                    itemId: 'cms_webpage_additionaldata_banners_columns_form_form_tabpanel_images',
                    listeners: {
    ...
    {
        var me = this;
        var tab = Ext.ComponentQuery.query('#cms_webpage_additionaldata_banners_columns_form_form_tabpanel_' + type)[0];
        ...
        {
            tab.hide();
            var label = Ext.ComponentQuery.query('#cms_webpage_additionaldata_banners_columns_form_form_' + type + '_msg_no_available_lang')[0];     
            label.show();
        }
        else
        {
                    ...
                    [
                        {
                            ...
                            [
                                {
                                    xtype: 'image',
                                    itemId: 'cms_website_additionaldata_banners_columns_form_image_image_' + lang_code,
                                    width: width,
                                    height: '150',
                                    border: 1,
                                    style: {
...
//                                            padding: '0 0 0 15',
                        ...
                        {
                           xtype: 'textfield',
                           itemId: 'cms_website_additionaldata_banners_columns_form_image_textfield_' + lang_code,
    ...
    editImage: function(lang_code)
    {
        ...
        info_store.on('load', function(this_store, records, successful, eOpts)
        {
            ...
            config.baseNode = "BANNERS";
            config.itemId = 'fileManager_cms_webpage_banners_form';
            ...
            file_manager.on('selectedFile', function(filename, filesize, filedate, relativePath, path){
                var textfield = Ext.ComponentQuery.query('#cms_website_additionaldata_banners_columns_form_image_textfield_' + lang_code)[0];
                var image = Ext.ComponentQuery.query('#cms_website_additionaldata_banners_columns_form_image_image_' + lang_code)[0];
