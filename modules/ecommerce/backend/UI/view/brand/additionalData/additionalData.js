Ext.define('App.modules.ecommerce.backend.UI.view.brand.additionalData.additionalData', {
    extend: 'Ext.button.Button',
    
    alias: 'widget.ecommerce_brand_additionaldata',
    itemId: 'ecommerce_brand_additionaldata',
        
    explotation: 'E-commerce additional data brand view (button menu)',
    ...
    {   
        ...
        var ret =       
        {
            ...
            handler: function()
            {
                ...
                config.form = Ext.widget('ecommerce_brand_additionaldata_descriptions').getForm(config);
