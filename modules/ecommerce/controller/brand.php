...
// Models
use modules\ecommerce\model\brand as brandModel;

/**
 * E-commerce brand controller
 *
 * @author Dani Gilabert
 * 
 */
class brand extends ecommerce
{
    protected function _getBrandModel($id = null)
    {
        return new brandModel($id);
    }
    
    protected function _getRawData($stale = 'update_after')
    {
        $model = $this->_getBrandModel();
    ...
    public function getBrands($public = false, $stale = 'update_after')
    {
        $ret = null;
    ...
    public function getBrandByCode($code, $public = false)
    {
        $ret = null;
        $model = $this->_getBrandModel();           
        $model_type = $model->type;
