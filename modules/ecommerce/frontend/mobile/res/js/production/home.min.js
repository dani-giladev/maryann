...
var home={mySlider:null,init:function(){home.initSlider();home.changeSliderContent();home.changeSliderPageHeight()},initSlider:function(){home.mySlider=new Swiper(".swiper-container",{pagination:{el:".swiper-pagination",type:"bullets"},nextButton:".swiper-button-next",prevButton:".swiper-button-prev",loop:true,autoplay:{delay:3000}})},changeSliderContent:function(){var a;a=$(".swiper-slides-landscape").html();home.mySlider.removeAllSlides();home.mySlider.appendSlide(a)},changeSliderPageHeight:function(){if($("#page-slider-wrapper").length<=0){return}var b=55;var c=window.innerWidth;var a=(c*b)/100;$("#page-slider-wrapper").height(a)}};$(function(){$(document).ready(function(){$(window).on("resize",function(a){home.init()});home.init()})});
