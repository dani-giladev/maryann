...
var menu={search_articles_timer:null,initSearcher:function(){$(document).on("click",".ui-input-clear",function(){var a=$("#searcher-list");a.html("");a.listview("refresh")});$("#searcher-input").keyup(function(a){if(a.keyCode==13){menu.updateList(true);return}clearInterval(menu.search_articles_timer);menu.search_articles_timer=setTimeout("menu.updateList()",500)})},updateList:function(d){var c=$("#searcher-list");var b=$("#searcher-input").val();if(b.length<3){c.html("");c.listview("refresh");return}if(d){window.location.href=base_url+"/showcase?search="+b;return}var a="controller=modules\\ecommerce\\frontend\\mobile\\controller\\menu\\searcher&method=search&value="+b;$.ajax({type:"GET",url:"index.php",data:a,success:function(e){e=JSON.parse(e);var f="";$.each(e,function(h,j){f+="<li>"+j+"</li>"});var g=$("#searcher-list");g.html(f);g.listview("refresh")}})},onClickSearchButton:function(){menu.updateList(true)}};$(function(){menu.initSearcher();$(document).ready(function(){})});
