...
var articledetail={setStyles:function(){if(is_mobile){return}var d=$(".page-center").width();var a=200;var c=d-a-50;$("#article-detail-related-articles-content").css({width:c+"px"});var b=$(".showcase-content-article").width();$(".showcase-content-article-img-wrapper").css({width:b+"px",height:b+"px"});if($(".showcase-content-article-wrapper").is(".fadeout")){$(".showcase-content-article-wrapper").removeClass("fadeout").addClass("fadein")}}};$(function(){$(window).resize(function(){articledetail.setStyles()});articledetail.setStyles();initCarousels();initMenus();initSpinners();initAddButtons();initTabs();initStarsRating();$(document).ready(function(){initValidateReviewsForm()})});function initCarousels(){var b=$("#article-detail-carousel");var a=b.attr("_items");if(a<2){$("#article-detail-carousel-control-prev").hide();$("#article-detail-carousel-control-next").hide();$("#article-detail-carousel-pagination").hide()}$(".fancybox").fancybox()}function initMenus(){if(is_mobile){return}$("#article-detail-introduction-availableformats-combo").menu()}function initSpinners(){if(is_mobile){return}initSpinner($("#article-detail-introduction-addtocart-amount-spinner"));$("input[name=showcase-content-article-addtocart-amount-spinner-name]").each(function(){initSpinner($(this))})}function initSpinner(e){var d=e.attr("_article_title");var b=(e.attr("_enable")=="1");var f=parseInt(e.attr("_stock"));var c=parseInt(e.attr("_min"));var a=parseInt(e.attr("_max"));e.spinner({min:c,max:a+1,step:1,change:function(g,i){var h=$(this).spinner("value");if(h<c){$(this).spinner("value",c)}else{if(h>a){$(this).spinner("value",a);ecommerce.showDialogWhenAddToCartWithSpinner(d,b,f,a)}}},spin:function(g,i){var h=i.value;if(h>a){e.spinner("value",a);g.preventDefault();ecommerce.showDialogWhenAddToCartWithSpinner(d,b,f,a)}}})}function initAddButtons(){initAddButton($("#article-detail-introduction-addtocart-button"));$("button[name=showcase-content-article-addtocart-button-name]").each(function(){initAddButton($(this))})}function initAddButton(b){var a=b.attr("_disabled");if(a){b.prop("disabled",true);b.removeClass("button-addtocart").addClass("button-disabled")}}function initTabs(){if(is_mobile){return}$("#article-detail-tabs").tabs({});$("#article-detail-tab-accordion-epigraphs").accordion({heightStyle:"content"});$("#article-detail-tab-accordion-messages").accordion({heightStyle:"content"})}function initStarsRating(){var b=$("#article-detail-introduction-reviews-star-rating");var a=b.attr("_rating");b.rateYo({starWidth:"17px",rating:a,readOnly:true});$("div[class=article-detail-reviews-review-star-rating]").each(function(){var c=$(this).attr("_rating");$(this).rateYo({starWidth:"17px",rating:c,fullStar:true,readOnly:true})});$("#article-detail-reviews-form-star-rating").rateYo({starWidth:"30px",spacing:"5px",fullStar:true})}function initValidateReviewsForm(){$("#article-detail-reviews-form-star-rating-error-text").hide();$("#article-detail-reviews-form").validate({event:"blur",rules:{name:{required:true},title:{required:true},text:{required:true}},messages:{name:msg_required_field,title:msg_required_field,text:msg_required_field},highlight:function(a){$(a).addClass("error")},unhighlight:function(a){$(a).removeClass("error")},debug:false,errorClass:"error",submitHandler:function(c){var b=$("#article-detail-reviews-form-star-rating").rateYo("rating");if(b<=0){$("#article-detail-reviews-form-star-rating-error-text").html(msg_rate_required).show();return}$("#article-detail-reviews-form-star-rating-error-text").hide();ecommerce.setMask(msg_wait_please);var a="controller="+ecommerce.getBaseController()+"\\articledetail&method=addReview&article_code="+article_code+"&rating="+b+"&name="+$("input[name=name]").val()+"&title="+$("input[name=title]").val()+"&text="+$("textarea[name=text]").val()+"";$.ajax({type:"POST",url:"index.php",data:a,success:function(d){$.unblockUI();d=JSON.parse(d);$.fancybox({content:d.htmlMsg,closeEffect:"none",closeBtn:true,beforeClose:function(){ecommerce.setMask(msg_wait_please);window.location.reload()}})}})}})}function addToShoppingcart(c){ecommerce.setMask(msg_processing_your_request);var b=$("input[name=showcase-content-article-addtocart-amount-spinner-name][_article_code='"+c+"']").val();var a="controller="+ecommerce.getBaseController()+"\\showcase&method=addToShoppingcart&code="+c+"&amount="+b;$.ajax({type:"GET",url:"index.php",data:a,success:function(d){$.unblockUI();d=JSON.parse(d);$("#shoppingcart-menu-option-amount-wrapper").html(d.shoppingcartAmount);$("#shoppingcart-menu-option-totalprice-wrapper").html(d.shoppingcartTotalPrice);$("#shoppingcart-menu-option").tooltipster("content",$(d.shoppingcartTooltip));$.fancybox({content:d.windowAfterAddToShoppingcart,closeEffect:"none",closeBtn:false});$("#showcase-content-article-addtocart-article-"+c).html(d.addToShoppingcartWidgetsContent);initSpinner($("input[name=showcase-content-article-addtocart-amount-spinner-name][_article_code="+c+"]"));initAddButton($("button[name=showcase-content-article-addtocart-button-name][_article_code="+c+"]"))}})}function addIndividualArticleToShoppingcart(c){ecommerce.setMask(msg_processing_your_request);var b=is_mobile?1:($("#article-detail-introduction-addtocart-amount-spinner").val());var a="controller="+ecommerce.getBaseController()+"\\articledetail&method=addIndividualArticleToShoppingcart&code="+c+"&amount="+b;$.ajax({type:"GET",url:"index.php",data:a,success:function(d){$.unblockUI();d=JSON.parse(d);if(!is_mobile){$("#shoppingcart-menu-option-amount-wrapper").html(d.shoppingcartAmount);$("#shoppingcart-menu-option-totalprice-wrapper").html(d.shoppingcartTotalPrice);$("#shoppingcart-menu-option").tooltipster("content",$(d.shoppingcartTooltip));$.fancybox({content:d.windowAfterAddToShoppingcart,closeEffect:"none",closeBtn:false});$("#article-detail-introduction-addtocart").html(d.addToShoppingcartWidgetsContent);initSpinner($("#article-detail-introduction-addtocart-amount-spinner"))}else{$("#shoppingcart-menu-option-amount-wrapper").html(d.shoppingcartAmount);$("#article-detail-introduction-addtocart").empty();$("#article-detail-introduction-addtocart").append(d.addToShoppingcartWidgetsContent).trigger("create")}initAddButton($("#article-detail-introduction-addtocart-button"))}})};
