...
var home={pheight:0,setStyles:function(){var d=$(".page-center").width();var a=200;var c=d-a-50;$("#home-novelty-articles-content").css({width:c+"px"});$("#home-outstanding-articles-content").css({width:c+"px"});var b=$(".showcase-content-article").width();$(".showcase-content-article-img-wrapper").css({width:b+"px",height:b+"px"});if($(".showcase-content-article-wrapper").is(".fadeout")){$(".showcase-content-article-wrapper").removeClass("fadeout").addClass("fadein")}if(!$("#home-slider-mask").is(".fadeout")){setTimeout(function(){$("#home-slider-mask").addClass("fadeout")},1000)}},initSlider:function(){$(".pgwSlider").pgwSlider({displayList:false,displayControls:true,intervalDuration:4500,transitionDuration:1500,maxHeight:home.pheight-100,verticalCentering:true,adaptiveHeight:true})}};$(function(){$(window).resize(function(){home.setStyles()});home.setStyles();home.pheight=$(window).height();$("#home-slider-mask").css({height:(home.pheight-100)+"px"});home.initSlider();$(document).ready(function(){})});
