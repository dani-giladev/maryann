...
$(function(){$(document).ready(function(){})});function validate(){var a="controller=modules\\ecommerce\\frontend\\controller\\webpages\\validation&method=validate";$.ajax({type:"GET",url:"index.php",data:a,success:function(b){b=JSON.parse(b);if(!b.success){if(!b.redirectUrl){alert(b.msg)}}window.location.href=b.redirectUrl}})};
