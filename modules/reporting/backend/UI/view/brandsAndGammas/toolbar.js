Ext.define('App.modules.reporting.backend.UI.view.brandsAndGammas.toolbar', {
    extend: 'Ext.toolbar.Toolbar',
    
    alias: 'widget.reporting_brands_and_gammas_toolbar',
    itemId: 'reporting_brands_and_gammas_toolbar',
...
//    ui: 'footer',
    ...
    {
        var me = this;
        var centerpanel = Ext.ComponentQuery.query('#reporting_brands_and_gammas_centerpanel')[0];
        
        var url = 
                //location.protocol + "//" + window.location.hostname + 
                "/index.php" +
                "?controller=modules\\reporting\\backend\\controller\\brandsAndGammas" +
                "&method=renderReport" +
                "";
